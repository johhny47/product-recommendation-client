    ...
    return (
        <div>
            ...
            <div
             ...
             className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 -mt-52 md:-mt-40 lg:-mt-0">
                {
                    data.map(data=><div
                       
                     className="card bg-[#e640c8]     w-72 md:w-80 lg:96 shadow-xl mx-auto text-gray-100">
                         <figure>
                          <img
